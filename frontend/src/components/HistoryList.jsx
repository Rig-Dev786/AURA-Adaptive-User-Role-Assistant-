  ...
  if (analyses.length === 0) {
    return (
      <div style={{
        ...
        color: "rgba(15,23,42,0.3)", fontFamily: "'Sora', sans-serif",
      }}>
  ...
  return (
    <div style={{ fontFamily: "'Sora', sans-serif", display: "flex", flexDirection: "column", gap: 12 }}>
      {analyses.map((a) => {
        ...
        const color = score > 60 ? "#0284c7" : score > 30 ? "#f59e0b" : "#0369a1";
        return (
          ...
          >
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              ...
              <div>
                <p style={{ color: "#0f172a", margin: 0, fontWeight: 600, fontSize: 14 }}>
            ...
            <span style={{ color: "rgba(15,23,42,0.3)", fontSize: 18 }}>→</span>
          </div>
        );
      })}
    </div>
